"""
Django settings for boneyardproj project.
...
SECRET_KEY = '8sr=f!_^#lr^q5bondq+0051bb(q2@!$-fc4vvxly(1+4cgf6y'
...
ROOT_URLCONF = 'boneyardproj.urls'
...
WSGI_APPLICATION = 'boneyardproj.wsgi.application'
